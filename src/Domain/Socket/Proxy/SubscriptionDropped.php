...
class SubscriptionDropped extends \ProtobufMessage
{
    ...
    protected static $fields = array(
        self::REASON => array(
            'default' => \EventStore\Client\Domain\Socket\Proxy\SubscriptionDropped\SubscriptionDropReason::Unsubscribed,
            'name' => 'reason',
            'required' => false,
            'type' => 5,
        ),
    ...
    {
        $this->values[self::REASON] = \EventStore\Client\Domain\Socket\Proxy\SubscriptionDropped\SubscriptionDropReason::Unsubscribed;
    }
