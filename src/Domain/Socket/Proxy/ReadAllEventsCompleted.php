...
class ReadAllEventsCompleted extends \ProtobufMessage
{
    ...
    protected static $fields = array(
        ...
        self::EVENTS => array(
            'name' => 'events',
            'repeated' => true,
            'type' => '\EventStore\Client\Domain\Socket\Proxy\ResolvedEvent'
        ),
        ...
        self::RESULT => array(
            'default' => \EventStore\Client\Domain\Socket\Proxy\ReadAllEventsCompleted\ReadAllResult::Success,
            'name' => 'result',
            'required' => false,
            'type' => 5,
        ),
    ...
    public function reset()
    {
        ...
        $this->values[self::RESULT] = \EventStore\Client\Domain\Socket\Proxy\ReadAllEventsCompleted\ReadAllResult::Success;
     ...
     *
     * @param \EventStore\Client\Domain\Socket\Proxy\ResolvedEvent $value Value to append
     *
     * @return null
     */
    public function appendEvents(\EventStore\Client\Domain\Socket\Proxy\ResolvedEvent $value)
    {
     ...
     * Returns 'events' list
     *
     * @return \EventStore\Client\Domain\Socket\Proxy\ResolvedEvent[]
     */
