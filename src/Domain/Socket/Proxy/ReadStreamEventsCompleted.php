...
class ReadStreamEventsCompleted extends \ProtobufMessage
{
     ...
     *
     * @param \EventStore\Client\Domain\Socket\Proxy\ResolvedIndexedEvent $value Value to append
     *
     * @return null
     */
    public function appendEvents(\EventStore\Client\Domain\Socket\Proxy\ResolvedIndexedEvent $value)
    {
