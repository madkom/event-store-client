...
/**
 * UpdatePersistentSubscriptionCompleted message
 */
class UpdatePersistentSubscriptionCompleted extends \ProtobufMessage
{
    ...
    protected static $fields = array(
        self::RESULT => array(
            'default' => \Madkom\EventStore\Client\Domain\Socket\Data\UpdatePersistentSubscriptionCompleted\UpdatePersistentSubscriptionResult::Success,
            'name' => 'result',
            'required' => true,
            'type' => 5,
        ),
